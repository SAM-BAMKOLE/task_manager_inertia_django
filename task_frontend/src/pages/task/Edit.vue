...
const onSubmit = () => {
  ...
  form.post(`/task/edit/${props.task.id}`, {
    forceFormData: true,
  });
};
...
onMounted(() => {
  selectedTags.value = props.task.tags.map((tag) => tag.name);
});
</script>
<template>
  <!-- Task Create Page -->
  ...
  <div id="task-create-page">
    <div class="mb-6">
      <h2 class="text-2xl font-bold">Edit Your Task</h2>
      <p class="text-base-content/60">Edit the details of your task</p>
    </div>
        ...
        <form @submit.prevent="onSubmit">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl">
            ...
            <div class="form-control flex flex-col gap-1">
              ...
              <div
                class="space-y-1 flex flex-col md:flex-row items-center gap-1 md:gap-3"
              >
                <div
                ...
                >
                  ...
                  >
                    <span class="whitespace-no-wrap">{{ tag }}</span>
                    <button
                      type="button"
